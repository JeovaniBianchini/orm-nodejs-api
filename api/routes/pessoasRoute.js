...
router.get('/pessoas/:estudanteId/matricula', PessoaCcontroller.pegaMatriculas)
router.get('/pessoas/matricula/:turmaId/confirmada', PessoaCcontroller.pegaMatriculasPorTurma)
router.get('/pessoas/matricula/lotada', PessoaCcontroller.pegaTurmasLotadas)
